...
### 🛡️ Actor 3: Quản trị viên hệ thống (System Administrator)
...
## 🛠️ 2. Bản Đồ Tính Năng Hệ Thống (System Features Map)
...
### ⏱️ Phân Hệ 6: Đếm Ngược Tập Trung (Focus Session - Pomodoro)
...
## 🏗️ 3. Kiến Trúc Công Nghệ Áp Dụng (Technology Stack)
